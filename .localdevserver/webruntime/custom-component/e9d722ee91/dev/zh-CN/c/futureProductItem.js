Webruntime.define('lwc/futureProductItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "img" + shadowSelector + " {height: 120px;border-radius: 10px;margin-bottom: 2px;display: block;margin-left: auto;margin-right: auto;}\n.item_footer" + shadowSelector + " {display: inline;margin-left: auto;margin-right: auto;margin-bottom: 2rem;}\ninput" + shadowSelector + " {width: 6em;height: 2.25rem;font-weight: bold;text-align: center;}\nh3" + shadowSelector + " {font-weight: bold;text-align: center;margin-bottom: 3px;}\np" + shadowSelector + " {text-align: center;}\n.item_button" + shadowSelector + " {margin-left: 4px;margin-right: 4px;font-weight: bolder;font-size: 1.5rem;}\n.price_tag" + shadowSelector + " {text-align: center;}\n.notificationText" + shadowSelector + " {font-weight: bold;font-size: 1rem;color: green;}\n";
    }
