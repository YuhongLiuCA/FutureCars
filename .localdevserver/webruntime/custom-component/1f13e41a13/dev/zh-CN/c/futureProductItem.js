Webruntime.define('lwc/futureProductItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "img" + shadowSelector + " {height: 120px;border-radius: 10px;margin-bottom: 2px;display: block;margin-left: auto;margin-right: auto;}\n.future-item-card" + shadowSelector + " {background-color: rgb(210,210,210);display: flex;flex-direction: column;}\n.item-description" + shadowSelector + " {display: flex;flex-direction: column;}\n.item-description-title" + shadowSelector + "{font-weight: bold;}\n.future-card-title" + shadowSelector + " {font-size: 10 rem;}\n.future-card-content" + shadowSelector + " {display: flex;flex-direction: row;}\n";
    }
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 3
      }, [api_text("Description")]), api_element("div", {
        classMap: {
        ...
        key: 4
      }, [api_dynamic($cmp.car.Description)])]), api_element("br", {
        key: 6
      }, []), api_element("div", {
        classMap: {
          "item-description-title": true
