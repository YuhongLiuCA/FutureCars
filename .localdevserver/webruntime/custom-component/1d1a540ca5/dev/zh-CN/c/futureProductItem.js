Webruntime.define('lwc/futureProductItem', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "img" + shadowSelector + " {width: 28vw;border-radius: 10px;margin-bottom: 2px;display: block;margin-left: auto;margin-right: auto;}\n.future-item" + shadowSelector + " {background-color: rgb(123,123,123);display: flex;flex-direction: column;}\n.future-item-card" + shadowSelector + " {background-color: rgb(123,123,123);display: flex;flex-direction: column;}\n.card-description" + shadowSelector + "{display: flex;flex-direction: column;max-width: 25vw;}\n.item-description-top" + shadowSelector + " {display: flex;flex-direction: column;background-color: rgb(210,210,210);margin-bottom: 1rem;margin-left: 2rem;border-radius: 10px;}\n.item-description-bottom" + shadowSelector + " {display: flex;flex-direction: column;background-color: rgb(210,210,210);margin-bottom: 1rem;margin-left: 2rem;border-radius: 10px;}\n.item-description-title" + shadowSelector + "{font-weight: bold;font-size: 28px;text-align: center;}\n.future-card-title" + shadowSelector + " {font-size: 20 rem;font-weight: bold;text-align: center;}\n.item-description-text" + shadowSelector + "{font-size: 14px;text-align: center;}\n.future-card-content" + shadowSelector + " {display: flex;flex-direction: row;justify-content: space-between;}\n";
    }
